...
// SETTING STATE VARIABLES FOR ARROW ANIMATION
const ForecastItems = ({ item, idx }) => {
  ...
  return (
    // ACCORDION COMPONENT FOR EACH DAY OF WEEK
    <div>
      <Accordion allowZeroExpanded>
        <AccordionItem key={idx}>
          <AccordionItemHeading>
            <AccordionItemButton>
              {/* CHANGING STATE OF ARROW AND POPULATING COMPONENT WITH ARROW DETAILS */}
              <div
